    ...
    class LoadAlbum extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            while (mergeCursor.moveToNext()) {
                String bucket_id = mergeCursor.getString(mergeCursor.getColumnIndexOrThrow(MediaStore.MediaColumns.BUCKET_ID));

                String path = mergeCursor.getString(mergeCursor.getColumnIndexOrThrow(MediaStore.MediaColumns.DATA));
                String album = mergeCursor.getString(mergeCursor.getColumnIndexOrThrow(MediaStore.MediaColumns.BUCKET_DISPLAY_NAME));
                String timestamp = mergeCursor.getString(mergeCursor.getColumnIndexOrThrow(MediaStore.MediaColumns.DATE_MODIFIED));
